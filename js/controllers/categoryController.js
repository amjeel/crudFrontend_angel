...
document.addEventListener("DOMContentLoaded", () =>{
    ...
    async function loadCategories(){
        try{
            ...
            //verifica si NO hay categorias regustradas
            if(!categories || categories.length == 0){
                ...
                categories.forEach((cat) =>{
                    ...
                    <td>${cat.descripcion || "Descrpción asignada"}</td>
                ...
                <button class="btn btn-sm btn-outline-danger delete-btn">
                    ...
                    //funcionalidad para boton editar categoria 
                    tr.querySelector(".edit-btn").addEventListener("click", () => {

                        //pasa los campos de tipo json a los campos del formulario
                    ...
                    //Funcionalidad para bóton de eliminar categoria
